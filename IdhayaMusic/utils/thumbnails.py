...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("IdhayaMusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("IdhayaMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("IdhayaMusic/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("IdhayaMusic/assets/play_icons.png")
